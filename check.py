...
DEPENDENCIES_URL = {
    ...
    'js': 'https://www.npmjs.com/package/{package_name}'
}
...
def is_unclaimed(package_name: str, language: str) -> tuple[bool,int]:
    ...
    r = requests.head(dependencies_url.format(package_name=package_name), headers={"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36"})
